...
// Free models verified working July 2026 — spread across providers
// so if one provider rate-limits, another kicks in
const MODELS = [
  'openai/gpt-oss-20b:free',            // fast, good quality
  'nvidia/nemotron-3-nano-30b-a3b:free', // quick fallback
  'google/gemma-4-31b-it:free',          // Google fallback
  'openai/gpt-oss-120b:free',            // bigger, slower last resort
];
